...
#include "segment_cover_path_planner.h"
#include <tf/transform_datatypes.h>
#include <bits/stdc++.h>

PLUGINLIB_EXPORT_CLASS(segment_cover_path_planner::SegmentCoverPathPlanner, nav_core::BaseGlobalPlanner)

using namespace std;

namespace segment_cover_path_planner
{
SegmentCoverPathPlanner::SegmentCoverPathPlanner ():
bgp_loader_("nav_core", "nav_core::BaseGlobalPlanner"),
world_model_(NULL),initialized_(false)
{}

SegmentCoverPathPlanner::SegmentCoverPathPlanner(std::string name, costmap_2d::Costmap2DROS* costmap_ros):
bgp_loader_("nav_core", "nav_core::BaseGlobalPlanner")
     {
        initialize(name, costmap_ros);
     }
bool SegmentCoverPathPlanner::plan_cleaning(std_srvs::SetBoolRequest  &req,
                                        std_srvs::SetBoolResponse  &res)
{
    ...
    segment_cover_path_planner::GetPlan srv;
...
void SegmentCoverPathPlanner::initialize(std::string name, costmap_2d::Costmap2DROS* costmap_ros)
     {
        if (!initialized_){
            ...
            plan_srv = private_nh.serviceClient<segment_cover_path_planner::GetPlan>("/get_cleaning_waypoint");
...
double SegmentCoverPathPlanner::distance(const geometry_msgs::Pose& p1, const geometry_msgs::Pose& p2)
     {
         return hypot(p1.position.x - p2.position.x, p1.position.y - p2.position.y);
     }     

void SegmentCoverPathPlanner::straightPlan(geometry_msgs::PoseStamped& start, geometry_msgs::Pose& goal, std::vector<geometry_msgs::PoseStamped>& plan){
        double vector[2],mag;
...
bool SegmentCoverPathPlanner::makePlan(const geometry_msgs::PoseStamped& start, const geometry_msgs::PoseStamped& goal, std::vector<geometry_msgs::PoseStamped>& plan)
    {   
 ...
 void SegmentCoverPathPlanner::publishPlan(const std::vector<geometry_msgs::PoseStamped>& path) {
 ...
 void SegmentCoverPathPlanner::publishcleanerPlan(const std::vector<geometry_msgs::PoseStamped>& path) {
    //create a message for the plan
    nav_msgs::Path gui_path;
    gui_path.poses.resize(path.size());
